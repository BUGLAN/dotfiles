...
# bindsym $mod+q kill easy to touch
...
for_window [class="netease-cloud-music"] floating enable resize set 800 600
# support qt program which i program
for_window [class="^qt*"] floating enable border normal
...
# screenshot
bindsym $mod+p exec gnome-screenshot --interactive
